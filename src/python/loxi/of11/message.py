    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("capabilities = ");
                value_name_map = {1: 'OFPC_FLOW_STATS', 2: 'OFPC_TABLE_STATS', 4: 'OFPC_PORT_STATS', 8: 'OFPC_GROUP_STATS', 32: 'OFPC_IP_REASM', 64: 'OFPC_QUEUE_STATS', 128: 'OFPC_ARP_MATCH_IP'}
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("flags = ");
                value_name_map = {1: 'OFPFF_SEND_FLOW_REM', 2: 'OFPFF_CHECK_OVERLAP'}
                q.text(util.pretty_flags(self.flags, value_name_map.values()))
                q.text(","); q.breakable()
                q.text("match = ");
                q.pp(self.match)
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("code = ");
                value_name_map = {0: 'OFPFMFC_UNKNOWN', 1: 'OFPFMFC_TABLE_FULL', 2: 'OFPFMFC_BAD_TABLE_ID', 3: 'OFPFMFC_OVERLAP', 4: 'OFPFMFC_EPERM', 5: 'OFPFMFC_BAD_TIMEOUT', 6: 'OFPFMFC_BAD_COMMAND'}
                if self.code in value_name_map:
                    q.text("%s(%d)" % (value_name_map[self.code], self.code))
                else:
                    q.text("%#x" % self.code)
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("flags = ");
                value_name_map = {0: 'OFPC_FRAG_NORMAL', 1: 'OFPC_FRAG_DROP', 2: 'OFPC_FRAG_REASM', 3: 'OFPC_FRAG_MASK', 4: 'OFPC_INVALID_TTL_TO_CONTROLLER'}
                q.text(util.pretty_flags(self.flags, value_name_map.values()))
                q.text(","); q.breakable()
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("code = ");
                value_name_map = {0: 'OFPGMFC_GROUP_EXISTS', 1: 'OFPGMFC_INVALID_GROUP', 2: 'OFPGMFC_WEIGHT_UNSUPPORTED', 3: 'OFPGMFC_OUT_OF_GROUPS', 4: 'OFPGMFC_OUT_OF_BUCKETS', 5: 'OFPGMFC_CHAINING_UNSUPPORTED', 6: 'OFPGMFC_WATCH_UNSUPPORTED', 7: 'OFPGMFC_LOOP', 8: 'OFPGMFC_UNKNOWN_GROUP'}
                if self.code in value_name_map:
                    q.text("%s(%d)" % (value_name_map[self.code], self.code))
                else:
                    q.text("%#x" % self.code)
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("code = ");
                value_name_map = {0: 'OFPPMFC_BAD_PORT', 1: 'OFPPMFC_BAD_HW_ADDR', 2: 'OFPPMFC_BAD_CONFIG', 3: 'OFPPMFC_BAD_ADVERTISE'}
                if self.code in value_name_map:
                    q.text("%s(%d)" % (value_name_map[self.code], self.code))
                else:
                    q.text("%#x" % self.code)
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("code = ");
                value_name_map = {0: 'OFPSCFC_BAD_FLAGS', 1: 'OFPSCFC_BAD_LEN'}
                if self.code in value_name_map:
                    q.text("%s(%d)" % (value_name_map[self.code], self.code))
                else:
                    q.text("%#x" % self.code)
    ...
    def pretty_print(self, q):
        ...
        with q.group():
            with q.indent(2):
                ...
                q.text(","); q.breakable()
                q.text("code = ");
                value_name_map = {0: 'OFPTMFC_BAD_TABLE', 1: 'OFPTMFC_BAD_CONFIG'}
                if self.code in value_name_map:
                    q.text("%s(%d)" % (value_name_map[self.code], self.code))
                else:
                    q.text("%#x" % self.code)
